...
function createLIdata(ul){
    const itemsPerPage = 5; 
    const totalPages = Math.ceil(jsonData.length / itemsPerPage);
    var previous = createLI();
    var previous_a  = createA(0,"Previous");
    ...
    var next = createLI();
    var next_a  = createA(jsonData.length+1,"Next");
...
function createA(num,name){
    var pageLink = document.createElement("a");
    pageLink.className ="page-link";
    pageLink.href = "#";
    pageLink.textContent = num;
    pageLink.innerHTML = name;
